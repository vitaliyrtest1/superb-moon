...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/602a36a25076580016477597
...
To start editing your site, you can use the Sanity interface at https://superb-moon-a36a2.sanity.studio/.
...
Generated at `2021-02-15T08:54:11.912Z` by Stackbit version `0.3.49-staging.0`.